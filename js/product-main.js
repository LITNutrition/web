    ...
    <div class="pd-section pd-cta-section">
      ...
      ${(() => {
        ...
        if (hasSeller) {
          return `
            <a class="pd-wa-cta"
               href="${buildWALink(state.seller.phone, `Hola ${sellerName}! Quiero más info sobre ${prod.name}`)}"
        ...
        return `<div class="pd-wa-cta" style="opacity:0.6;pointer-events:none;font-size:0.85rem;">Tu asesor no configuró WhatsApp</div>`;
      })()}
    </div>
